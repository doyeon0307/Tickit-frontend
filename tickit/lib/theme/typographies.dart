...
class Typo {
  ...
  static TextStyle pretendardSB24 = const TextStyle(
    fontFamily: "Pretendard",
    fontWeight: FontWeight.w600,
    fontSize: 24.0,
  );

  static TextStyle pretendardSB22 = const TextStyle(
    fontFamily: "Pretendard",
    fontWeight: FontWeight.w600,
    fontSize: 22.0,
  );

  static TextStyle pretendardSB20 = const TextStyle(
    fontFamily: "Pretendard",
    fontWeight: FontWeight.w600,
    fontSize: 20.0,
  );

  static TextStyle pretendardSB18 = const TextStyle(
    fontFamily: "Pretendard",
    fontWeight: FontWeight.w600,
    fontSize: 18.0,
  );

  static TextStyle pretendardR22 = const TextStyle(
    fontFamily: "Pretendard",
  ...
  static TextStyle pretendardR14 = const TextStyle(
    fontFamily: "Pretendard",
    fontWeight: FontWeight.w400,
    fontSize: 14.0,
  );
  ...
  static TextStyle pretendardR8 = const TextStyle(
    fontFamily: "Pretendard",
    fontWeight: FontWeight.w400,
    fontSize: 8.0,
  );
