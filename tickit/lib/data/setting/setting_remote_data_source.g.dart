...
part of 'setting_remote_data_source.dart';
...
class _SettingRemoteDataSource implements SettingRemoteDataSource {
  ...
  @override
  Future<ApiResponse<ProfileEntity>> getUserProfile() async {
